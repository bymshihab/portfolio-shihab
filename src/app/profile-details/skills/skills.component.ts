  ...
  skillCategories = [
    {
      ...
      skills: [
        { name: 'Angular', level: 60, endorsements: 45 },
        { name: 'TypeScript', level: 55, endorsements: 38 },
        { name: 'JavaScript', level: 75, endorsements: 52 },
        { name: 'HTML5', level: 95, endorsements: 42 },
        { name: 'CSS3', level: 75, endorsements: 35 },
